...
public class MediaHelper {
    ...
    public static String createCSVFileName(String initial) {
        Long timeStampLong = System.currentTimeMillis();
        String timeStamp = timeStampLong.toString();
        String mImageName = initial + timeStamp + ".csv";
        return mImageName;
    }

    public static String createPDFFileName(String initial) {
        Long timeStampLong = System.currentTimeMillis();
        String timeStamp = timeStampLong.toString();
        String mImageName = initial + timeStamp + ".pdf";
        return mImageName;
    }

    public static void createMediaDirectory() {
        File mediaStorageDir = new File(
                MediaConst.getInstance().IMAGE_DIRECTORY_PATH);
    ...
    public File getOutputCSVFile(String initialName) {
        MediaConst.getInstance().CreateFileStructure();
        File mediaStorageDir = new File(
                MediaConst.getInstance().CSV_DIRECTORY_PATH);
        if (!mediaStorageDir.exists()) {
            if (!mediaStorageDir.mkdirs()) {
                return null;
            }
        ...
        // Create a media file name
        String mImageName = createCSVFileName(initialName);
    ...
    public File getOutputPDFFile(String initialName) {
        MediaConst.getInstance().CreateFileStructure();
        File mediaStorageDir = new File(
                MediaConst.getInstance().PDF_DIRECTORY_PATH);
        if (!mediaStorageDir.exists()) {
            if (!mediaStorageDir.mkdirs()) {
                return null;
            }
        ...
        // Create a media file name
        String mImageName = createPDFFileName(initialName);
